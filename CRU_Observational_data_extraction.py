...
########################################################################################################
"""
Program: CRU Observational data extraction
Description: This program reads in CRU observational climate netcdf files, slices them to time periods of interest, calculates monthly means, and then
outputs the data in csv and netcdf format. 
Author: Richard Fewster (gy15ref@leeds.ac.uk)
Start Date: 22/05/2020
Most Recent Update: 22/05/2020
