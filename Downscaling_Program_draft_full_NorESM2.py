...
tas_file_hist = r"G:\Climate_Data\1_CMIP_DATA\2_CMIP6\1_NorESM2_MM\tmp\historical\*.nc"
tas_file_hist = xr.open_mfdataset(tas_file_hist, combine='by_coords')
tas_file_ssp1 = r"G:\Climate_Data\1_CMIP_DATA\2_CMIP6\1_NorESM2_MM\tmp\ssp1_26\*.nc"
tas_file_ssp1 = xr.open_mfdataset(tas_file_ssp1, combine='by_coords')
tas_file_ssp2 = r"G:\Climate_Data\1_CMIP_DATA\2_CMIP6\1_NorESM2_MM\tmp\ssp2_45\*.nc"
tas_file_ssp2 = xr.open_mfdataset(tas_file_ssp2, combine='by_coords')
tas_file_ssp3 = r"G:\Climate_Data\1_CMIP_DATA\2_CMIP6\1_NorESM2_MM\tmp\ssp3_70\*.nc"
tas_file_ssp3 = xr.open_mfdataset(tas_file_ssp3, combine='by_coords')
tas_file_ssp5 = r"G:\Climate_Data\1_CMIP_DATA\2_CMIP6\1_NorESM2_MM\tmp\ssp5_85\*.nc"
tas_file_ssp5 = xr.open_mfdataset(tas_file_ssp5, combine='by_coords')

# Precipitation files
# For models with multiple decadal files, put an asterisk after the folder name e.g. "..historical\*.nc"
pre_file_hist = r"G:\Climate_Data\1_CMIP_DATA\2_CMIP6\1_NorESM2_MM\pre\historical\*.nc"
pre_file_hist = xr.open_mfdataset(pre_file_hist, combine='by_coords')
pre_file_ssp1 = r"G:\Climate_Data\1_CMIP_DATA\2_CMIP6\1_NorESM2_MM\pre\ssp1_26\*.nc"
pre_file_ssp1 = xr.open_mfdataset(pre_file_ssp1, combine='by_coords')
pre_file_ssp2 = r"G:\Climate_Data\1_CMIP_DATA\2_CMIP6\1_NorESM2_MM\pre\ssp2_45\*.nc"
pre_file_ssp2 = xr.open_mfdataset(pre_file_ssp2, combine='by_coords')
pre_file_ssp3 = r"G:\Climate_Data\1_CMIP_DATA\2_CMIP6\1_NorESM2_MM\pre\ssp3_70\*.nc"
pre_file_ssp3 = xr.open_mfdataset(pre_file_ssp3, combine='by_coords')
pre_file_ssp5 = r"G:\Climate_Data\1_CMIP_DATA\2_CMIP6\1_NorESM2_MM\pre\ssp5_85\*.nc"
...
tmp_DIR = r'G:\Climate_Data\1_CMIP_DATA\2_CMIP6\1_NorESM2_MM\downscaled_outputs\NorESM2_downscaled_monthly_tas_'

# Export path for precipitation files
pre_DIR = r'G:\Climate_Data\1_CMIP_DATA\2_CMIP6\1_NorESM2_MM\downscaled_outputs\NorESM2_downscaled_monthly_pre_'
